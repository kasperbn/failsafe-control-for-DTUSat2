...
\def\thesisnumber{26}  % Only number no year
\def\thesisauthor{Kasper Bjørn Nielsen} % Thesis author
...
\bibitem{eventmachine}
	Eventmachine Documentation. 28-06-2010 \texttt{<http://eventmachine.rubyforge.org>}

\bibitem{json}
	JSON Format. 28-06-2010 \texttt{<http://www.json.org>}
